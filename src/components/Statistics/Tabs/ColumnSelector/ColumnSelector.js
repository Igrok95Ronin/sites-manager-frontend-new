...
const ColumnSelector = ({
  ...
  return (
    <>
      ...
      {/* Кнопка сброса всех настроек (очистка localStorage) */}
      <Tooltip title="Сбросить все настройки" arrow>
        <Button
          sx={{
          ...
          onClick={() => {
            const confirmed = window.confirm(
              `Вы уверены, что хотите сбросить все настройки?\n\nВ результате будут сброшены:\n\n• Выбранные фильтры\n• Отмеченные поля и порядок их отображения\n• Размер шрифта таблицы\n• Количество строк на странице\n• Поле поиска\n• Дата выборки данных\n• Все индивидуальные пользовательские настройки\n\nБудет очищено хранилище браузера (localStorage), и страница перезагрузится.`,
            );
